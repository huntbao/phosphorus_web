  ...
  render() {
        ...
        <div className="coll-req-actions-wrap">
          ...
          <DropDownMenu
            ...
            onClickItem={(menuItem, e) => {
              this.onClickReqMenuItem(menuItem, collection, req, e)
            }}/>
        </div>
      )
    }
    return (
      <div
        ...
        onDragStart={(e) => {
          this.dragStart(e, req.id)
        }}
        onDragOver={(e) => {
          this.dragOver(e)
        }}
        onDragEnter={(e) => {
          this.dragEnter(e, req.id)
        }}
        onMouseLeave={(e) => {
          this.onMouseLeaveReq(e)
        }}
        className={classes}
        onClick={(e) => {
          this.onClickURL(req.id, collection, e)
        }}
      >
