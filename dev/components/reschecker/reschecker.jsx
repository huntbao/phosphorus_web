    ...
    if (kvs.length === 0) {
      ...
      mainCon =
        <KeyValueT
          ...
          kvs={kvs}
          toggleKV={(rowIndex) => {
            this.toggleResCheckerKV(rowIndex)
          }}
          addKV={(rowIndex, kv) => {
            this.addResCheckerKV(rowIndex, kv)
          }}
          removeKV={(rowIndex) => {
            this.removeResCheckerKV(rowIndex)
          }}
          changeKVKey={(rowIndex, value) => {
            this.changeResCheckerKVKey(rowIndex, value)
          }}
          changeKVValue={(rowIndex, value) => {
            this.changeResCheckerKVValue(rowIndex, value)
          }}
          changeKVValueType={(rowIndex, value) => {
            this.changeResCheckerKVValueType(rowIndex, value)
          }}
          changeKVChildValueType={(rowIndex, value) => {
            this.changeResCheckerKVChildValueType(rowIndex, value)
          }}
        />
    }
