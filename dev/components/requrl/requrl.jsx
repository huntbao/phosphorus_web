    ...
    return (
      <div className={modClass}>
        <div className={reqWrapClasses}>
          <div className="requrl-method" onClick={(e) => {
            this.toggleMethodList(e)
          }}>
            <span className="requrl-method-name">{this.props.tab.method}</span>
            <span className="glyphicon glyphicon-chevron-down"></span>
          </div>
          <DropDownMenu menus={this.props.reqMethods} onClickItem={(n) => {
            this.onSelectMethod(n)
          }}/>
        ...
        <button className="requrl-send" onClick={() => {
          this.sendReq()
        }}>
          <em className="glyphicon glyphicon-send"></em>
        </button>
        <button className="requrl-save" onClick={() => {
          this.saveReq()
        }} disabled={!this.props.tab.isDirty}>
