  ...
  getSuccessTip() {
    ...
    return (
      <div className={tipClasses}>
        ...
        <ol className="res-types" onClick={(e) => {
          this.changeShowType(e)
        }}>
  ...
  getPrettyTypeNodes(showType) {
    ...
    return (
      <span className={prettyTypeClasses}>
        <span className="prettytype-wrap" onClick={(e) => {
          this.togglePrettyTypeList(e)
        }}>
          <span className="prettytype-name">{showType.prettyType}</span>
          <span className="glyphicon glyphicon-chevron-down"></span>
        </span>
        <DropDownMenu menus={this.props.prettyTypes} onClickItem={(v) => {
          this.onSelectPrettyTypeValue(v)
        }}/>
      </span>
    )
  }
